...
export async function getSortedPostsData() {
  ...
  console.log('Raw fetched posts:', posts.map(p => ({ title: p.title, contentLength: p.content.length })));
  ...
  const sortedPosts = posts
    ...
    .map(post => {
      ...
      console.log('Mapped post:', { title: mappedPost.title, contentLength: mappedPost.content.length });
      return mappedPost;
    })
    .sort((a, b) => {
